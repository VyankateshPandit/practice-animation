...
import "./AboutScreen.css"; // Keep this for global styles or font imports
import HeroBanner from "./HeroBanner"; // Assuming this and other components are in the same directory
import OurAchievement from "./OurAchievement";
import OurStudentsGotInto from "../../components/OurStudentsGotInto";
...
import FAQSection from "../home/HomepageFAQSection";
...
const About = () => {
  ...
  const teamData = {
    ...
    description:
      "Behind every great score is a great mentor. At EEC, our team is made up of certified professionals, passionate educators, and counselors who care about your growth as much as your grades.",
    members: [
      {
        ...
        imageUrl: "/images/img2.png", // Replace with actual path
      },
      {
        name: "Ms. Priya Mehta",
      ...
      },
      {
        ...
        rating: 8.5,
        description:
          "IELTS speaking specialist with a knack for boosting confidence and fluency",
        imageUrl: "/images/image.png",
      },
    ],
  };
  ...
  return (
    <div className="about-wrapper min-h-screen bg-white font-inter max-w-6xl mx-auto pt-[50px]">
      {/* Each section component will now be constrained by the 'about-wrapper' */}
      <Navbar />
      <HeroBanner />
      <OurAchievement />
      <OurStudentsGotInto />
      ...
      <FeatureCardsSection 
        ...
        sectionDescription='We’re not just another IELTS coaching center. We’re your test prep partners — committed to your score, your goals, and your future.' 
      />

      {/* <EecEdge /> */}
      <MeetOurFaculty data={teamData} />
      <TestimonialSection
