  ...
  return (
    <div className="event-webinar">
      ...
      <div className="flex flex-col justify-center items-start gap-4 w-full px-4 py-9">
        <Card
          subHeading="Address • 18 April, 2025"
          heading="Study MS & Ph.D. Abroad: Seminar with Professor Ankur "
          id="1"
        />
        <Card
          subHeading="Address • 18 April, 2025"
          heading="Under Grads: Visa Preparations & College Selection "
          id="2"
        />
        <Card
          subHeading="Address • 18 April, 2025"
          heading="Under Grads: Seminar on Under Graduate Admissions Process"
          id="3"
        />
      </div>
